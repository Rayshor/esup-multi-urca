...
- `KNOWLEDGE_BASE_SERVICE_CACHE_TTL_MS`: Durée de vie du cache en millisecondes (default: 300)
- `KNOWLEDGE_BASE_SERVICE_CACHE_MAX`: Max des entrées enregistrées en cache (default: 200)
