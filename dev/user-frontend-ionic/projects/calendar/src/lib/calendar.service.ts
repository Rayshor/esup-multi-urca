...
export class CalendarService {
  ...
  generateIcsFile(event: any): string {
...
BEGIN:VCALENDAR
VERSION:2.0
PRODID:-//Universite/Event//FR
CALSCALE:GREGORIAN
BEGIN:VEVENT
UID:${this.generateUid()}
DTSTAMP:${this.formatDate(new Date())}
DTSTART;TZID=Europe/Paris:${this.formatDate(startDate)}
DTEND;TZID=Europe/Paris:${this.formatDate(endDate)}
SUMMARY:${title}
LOCATION:${location}
